                ...
                <div class="card border-0">
                    <div class="card-body py-5 px-5">
                        ...
                        @foreach ($transaction->details as $item)
                            <div class="row mt-2">
                                <div class="col-7">
                                    <p class="mb-0 text-dark fw-semibold">{{ $item->produk->name }}</p>
                                ...
                                <div class="col-5">
                                    ...
                                    <p class="mb-0 text-secondary text-end fs-7">{{ number_format($item->quantity) }}
                                    </p>
                                </div>
                            </div>
                        @endforeach
                        ...
                        <div class="d-flex align-items-center justify-content-between mt-2">
                            ...
                            <p class="mb-0 text-dark fw-semibold">Rp. {{ number_format($transaction->total) }}
                            </p>
                        </div>
                        <hr class="my-4" style="border-style: dashed;">
                        <div class="d-flex align-items-center justify-content-between mt-2">
                        ...
                        <a href="{{ route('cashier.print', $transaction->id) }}" class="btn btn-secondary d-block mt-2"
                            target="_blank">
                            <i class="bx bx-print"></i> Cetak Struk
                        </a>
                    </div>
                </div>
            </div>
